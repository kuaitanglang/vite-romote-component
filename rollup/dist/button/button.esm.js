import { ref, reactive, getCurrentInstance, defineComponent, computed, createVNode, watch, onActivated, onDeactivated, onBeforeUnmount, provide, watchEffect, inject, mergeProps, openBlock, createElementBlock, createElementVNode, toDisplayString, unref, withCtx, createTextVNode } from 'vue';
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", null, [
        createElementVNode(
          ...
          " click times " + toDisplayString(unref(count)),
          1
          /* TEXT */
        ),
